...
def get_summary_by_service(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail=f"Failed to get summary: {str(e)}")
...
def get_total_cost(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail=f"Failed to get total: {str(e)}")
...
def create_cost(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail=f"Failed to create cost: {str(e)}")
...
def list_costs(
    ...
    limit: int = Query(100, ge=1, le=10000),  # ✅ FIX : 1000 → 10000
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail=f"Failed to list costs: {str(e)}")
...
def get_cost(
    ...
    try:
        ...
        if not cost:
            raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=f"Cost {cost_id} not found")
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail=f"Failed to get cost: {str(e)}")
...
def update_cost(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail=f"Failed to update cost: {str(e)}")
...
def delete_cost(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail=f"Failed to delete cost: {str(e)}")